...
<body id="page-top">
         ...
         <div class="col-12">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            ...
                            <img src="../post_img/<?php echo $p_pic?>" width="100" height="100" alt="">
                        </div>
                        <br>
                    <div class="form-group">
    ...
    if(isset($_POST['update'])){
        ...
        $update_post = "update all_posts set p_title='$p_title', p_description='$p_description', p_content='$p_content', p_pic='$p_pic',p_user='$p_user' where p_id='$post_id'";
